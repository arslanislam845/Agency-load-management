  ...
  <div class="flex flex-row ">
    <div
      ...
      <div class=" flex items-center justify-between text-gray-600 text-3xl px-3 mb-8">
        <img src="2.png" alt="logo" style=" object-position: center;">
      </div>

      <div class="p-2 pb-0 mt-10">
      ...
      <div class="flex flex-col flex-auto pl-10 mt-3">
        ...
        <div class="p-2 bg-pink-100">
          <div class="flex flex-row space-x-3">
            ...
            <a href="factoryindex.php" class="font-bold text-gray-500 text-pink-600 ">Dashboard</a>
          </div>
        </div>
    ...
    <div class=" text-center mt-5">
      <p class="font-bold text-3xl text-black p-1 pt-2 "> Naveed & Brothers(Factory details)</p>
    </div>
