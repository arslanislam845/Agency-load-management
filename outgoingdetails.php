      ...
      <div class="flex flex-col flex-auto pl-10 mt-3">
        ...
        <div class="p-2 bg-pink-100">
          <div class="flex flex-row space-x-3">
            ...
            <a href="outgoingdetails.php" class="font-bold text-gray-500 text-pink-600">Outgoing Details</a>
          </div>
        </div>
    ...
    <div class="ml-[20rem]">
      ...
      <section class="bg-white p-5 contain px-10 ">
        ...
        <?php
          ...
          $sql = "SELECT sheets,creates,bottels,stands,baskets,date FROM `newload`.`outgoingload` ORDER BY id DESC ";
