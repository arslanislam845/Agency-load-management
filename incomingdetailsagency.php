  ...
  <div
      ...
      <div class="flex flex-col flex-auto pl-10 mt-3">
        ...
        <div class="p-2 bg-pink-100 ">
          <div class="flex flex-row space-x-3 ">
            ...
            <a href="incomingdetailsagency.php" class="font-bold text-gray-500 text-pink-600">Incoming Details</a>
          </div>
        </div>
        <div class="p-2 hover:bg-pink-100">
          <div class="flex flex-row space-x-3">
    ...
    <div class="ml-[20rem]">
      ...
      <section class="bg-white p-5 contain px-10 ">
        ...
        <h1 class="font-bold text-3xl text-black text-center py-3 ml-[16rem]">Incoming Load Details</h1>
        <?php

          include 'db-connection.php';

          $sql = "SELECT sheets,creates,bottels,stands,baskets,date FROM `newload`.`incomingloadagency` ORDER BY id DESC";
          ...
          if (mysqli_num_rows($result) > 0) {
              ...
              while($row = $result->fetch_assoc()) {
                  ...
                  <tr>
                    ...
                    '.$row["stands"].'</td>
                    <td class="whitespace-nowrap px-3 py-4 text-xl   text-gray-900">'.$row["baskets"].'</td>
