...
<body>
  ...
  <div
      ...
      <div class="flex flex-col flex-auto pl-10 mt-3">
        ...
        <div class="p-2 hover:bg-pink-100">
          <div class="flex flex-row space-x-3">
            ...
            <a href="distindex.php" class="font-bold text-gray-500 hover:text-pink-600 ">Dashboard</a>
          </div>
        </div>
        <div class="p-2 hover:bg-pink-100 ">
          <div class="flex flex-row space-x-3 ">
        ...
        <div class="p-2 bg-pink-100">
          <div class="flex flex-row space-x-3">
            ...
            <a href="outgoingdetailsagency.php" class="font-bold text-gray-500 text-pink-600">Outgoing Details</a>
          </div>
        </div>
    ...
    <div class="ml-[20rem]">
      <div class=" text-center mt-5 ml-[20rem]">
        <p class="font-bold text-3xl text-black p-1 pt-2 "> Naveed & Brothers</p>
      </div>


      <section class="bg-white p-5 contain px-10 ">

        <h1 class="font-bold text-3xl text-black text-center py-3 ml-[16rem]">Outgoing Load Details</h1>
        <?php

          include 'db-connection.php';

          $sql = "SELECT sheets,creates,bottels,stands,baskets,date FROM `newload`.`outgoingloadagency` ORDER BY id DESC";
      
          $result = mysqli_query($conn, $sql);

          if (mysqli_num_rows($result) > 0) {
              echo '<table class=" min-w-[150%] border-2 divide-y divide-gray-300 mb-10">
              ...
              while($row = $result->fetch_assoc()) {
                  ...
                  <tr>
                    <td class="whitespace-nowrap py-4 pl-4 pr-3 text-xl  text-gray-900 sm:pl-6">'.$row["sheets"].'</td>
      
                    <td class="hidden whitespace-nowrap px-3 py-4 text-xl  text-gray-900 sm:table-cell">'.$row["creates"].'</td>
                    
                    <td class="whitespace-nowrap px-3 py-4 text-xl   text-gray-900">'.$row["bottels"].'</td>
                    
                    <td class="hidden whitespace-nowrap px-3 py-4 text-xl  text-gray-900 lg:table-cell">'.$row["stands"].'</td>
                    
                    <td class="hidden whitespace-nowrap px-3 py-4 text-xl  text-gray-900 lg:table-cell">'.$row["baskets"].'</td>
